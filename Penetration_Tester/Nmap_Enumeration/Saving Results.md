...
With the `XML` output, we can generate `HTML` reports that are easy to read, even for non-technical audiences. This is very useful for documentation, as it presents `Nmap` results in a detailed and clear format. To convert stored `.xml` results into `HTML`, we can use the tool `xsltproc`.
...
![[Pasted image 20251005124934.png]]
